...
},{"./components/PageLayout":162,"react":156}],158:[function(require,module,exports){
var React = require('react');

module.exports = Card = React.createClass({displayName: "Card",
	...
	render: function(){
		...
		return (
			React.createElement("div", {className: "b_surveys_card"}, 
				React.createElement("div", {className: "b_surveys_card_frame", onClick: this.handleChange}, 
					React.createElement("div", {className: "b_surveys_card_product-name", title: card.item_name}, card.item_name), 
					React.createElement("div", {className: "b_surveys_card_name"}, card.brand_name), 
					React.createElement("div", {className: "b_surveys_card_value"}, card.nf_calories, " kcal")
				)				
			)
		);
	}
...
module.exports = Cards = React.createClass({displayName: "Cards",
    render: function() {
        var cards,
        ...
        if (this.props.data) {
            cards = this.props.data.hits.map(function(oneCard){
                return (
                    React.createElement(Card, {card: oneCard.fields, key: oneCard._id, onCardClick: onCardClickValue})
                )
            });
        } else {
            cards = '';
        ...
        return ( 
        	React.createElement("div", {className: "b_surveys_cards"}, 
        		cards
            )
        );
    }
...
},{"./Card":158,"react":156}],160:[function(require,module,exports){
var React = require('react');

module.exports = Footer = React.createClass({displayName: "Footer",
	render: function(){
		return (
				React.createElement("div", {className: "b_surveys_footer b_surveys_island"}, 
					React.createElement("div", {className: "b_surveys_footer_item"}, "Tatiana Trubitcyna-Briones"), 
					React.createElement("div", {className: "b_surveys_footer_item"}, "2015")
				)
			);
	}
});
...
module.exports = Header = React.createClass({displayName: "Header",
	render: function(){
		return (
				React.createElement("div", {className: "b_surveys_header"}, 
					React.createElement("div", {className: "b_surveys_header_content"}, 
						React.createElement("div", {className: "b_surveys_header_appName"}, "Surveys"), 
						React.createElement(Points, {totalPoints: this.props.totalPoints}), 
						React.createElement("div", {className: "b_surveys_header_userPic"}, "UserPic")
					)
				)
			);
	}
...
module.exports = PageLayout = React.createClass({displayName: "PageLayout",
    getInitialState: function() {
        return {
            totalPoints: 0,
            data: '',
    ...
    render: function() {
        return ( 
            React.createElement("div", null, 
                React.createElement(Header, {totalPoints: this.state.totalPoints}), 
                React.createElement("div", {className: "b_surveys_pageLayout"}, 
                    React.createElement(Survey, {data: this.state.data, onCardClick: this.handleOnCardClick}), 
...
},{"./Footer":160,"./Header":161,"./Points":163,"./Survey":164,"react":156}],163:[function(require,module,exports){
var React = require('react');

module.exports = Points = React.createClass({displayName: "Points",
	render: function(){
		var totalPoints = this.props.totalPoints;
		return (
			React.createElement("div", {className: "b_surveys_points"}, 
				React.createElement("span", {className: "b_surveys_points_amount"}, totalPoints), " points"
			)
		);
	}
});
...
module.exports = Survey = React.createClass({displayName: "Survey",
    render: function() {
        return ( 
        	React.createElement("div", {className: "b_surveys_survey b_surveys_island"}, 
        		React.createElement(Text, null), 
        		React.createElement(Cards, {data: this.props.data, onCardClick: this.props.onCardClick})
            )
        );
    }
});

},{"./Cards":159,"./Text":165,"react":156}],165:[function(require,module,exports){
var React = require('react');

module.exports = Text = React.createClass({displayName: "Text",
	render: function(){
		return (React.createElement("div", {className: "b_surveys_text"}, "Click on the product you like the most:"));
	}
});
